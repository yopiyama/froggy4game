...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FPS] = LAYOUT( \
      ...
      KC_PSCR, KC_A,    KC_S,    KC_D,    KC_F, KC_G,                   _______,  _______,  _______,  _______,  _______,  _______, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V, KC_B, KC_TRNS, _______, _______,  _______,  _______,  _______,  _______,  _______, \
      KC_LCTL, _______, KC_SPC,  KC_LALT, KC_J, KC_M, KC_SPACE,  _______, _______,  _______,  _______,  _______,  _______,  _______ \
	  )
};
